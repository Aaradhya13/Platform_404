        ...
        <header className="bg-blue-600 shadow-sm border-b">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-2xl font-bold text-white">Maintenance Job Cards</h1>
                <p className="text-blue-100">Create and manage maintenance job cards</p>
              </div>
          ...
          {jobCards.length === 0 && (
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-gray-500 text-lg">No maintenance job cards found</p>
                <motion.button
                ...
                >
                  <Plus size={18} />
                  Create Your First Maintenance Job Card
                </motion.button>
              </div>
            </motion.div>
          )}
