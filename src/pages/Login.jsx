...
//     shetty: { password: "7760", role: "admin", department: "admin" },
//     sakshi: { password: "platform-404", role: "user", department: "operations" },
//     khush: { password: "platform-404", role: "user", department: "maintenance" },
//     khushbu: { password: "platform-404", role: "user", department: "inspection" },
//     aradhya: { password: "platform-404", role: "user", department: "cleaning" }
//   };
...
//               <div className="mt-4 p-4 rounded-lg text-sm" style={{ backgroundColor: '#E8F5E8', borderColor: '#4CAF50', border: '1px solid' }}>
//                 <div className="flex items-center mb-2">
//                   <User className="w-4 h-4 mr-2" style={{ color: '#2E7D32' }} />
//                   <p className="font-semibold" style={{ color: '#2E7D32' }}>Test Login Credentials</p>
//                 </div>
                
//                 <div className="space-y-2">
//                   <div className="bg-white p-2 rounded border-l-4" style={{ borderColor: '#FF5722' }}>
//                     <p className="font-medium text-gray-800">👨‍💼 Admin Access</p>
//                     <p className="text-sm text-gray-600">Username: <span className="font-mono bg-gray-100 px-1 rounded">shetty</span> | Password: <span className="font-mono bg-gray-100 px-1 rounded">7760</span></p>
//                   </div>
                  
//                   <div className="bg-white p-2 rounded border-l-4" style={{ borderColor: '#2196F3' }}>
//                     <p className="font-medium text-gray-800">⚙️ Operations</p>
//                     <p className="text-sm text-gray-600">Username: <span className="font-mono bg-gray-100 px-1 rounded">sakshi</span> | Password: <span className="font-mono bg-gray-100 px-1 rounded">platform-404</span></p>
//                   </div>
                  
//                   <div className="bg-white p-2 rounded border-l-4" style={{ borderColor: '#9C27B0' }}>
//                     <p className="font-medium text-gray-800">🔧 Maintenance</p>
//                     <p className="text-sm text-gray-600">Username: <span className="font-mono bg-gray-100 px-1 rounded">khush</span> | Password: <span className="font-mono bg-gray-100 px-1 rounded">platform-404</span></p>
//                   </div>
                  
//                   <div className="bg-white p-2 rounded border-l-4" style={{ borderColor: '#FF9800' }}>
//                     <p className="font-medium text-gray-800">🔍 Inspection</p>
//                     <p className="text-sm text-gray-600">Username: <span className="font-mono bg-gray-100 px-1 rounded">khushbu</span> | Password: <span className="font-mono bg-gray-100 px-1 rounded">platform-404</span></p>
//                   </div>
                  
//                   <div className="bg-white p-2 rounded border-l-4" style={{ borderColor: '#4CAF50' }}>
//                     <p className="font-medium text-gray-800">🧹 Cleaning</p>
//                     <p className="text-sm text-gray-600">Username: <span className="font-mono bg-gray-100 px-1 rounded">aradhya</span> | Password: <span className="font-mono bg-gray-100 px-1 rounded">platform-404</span></p>
//                   </div>
//                 </div>
...
//                     Backend hosted on free service - may take time to respond
//                   </p>
//                 </div>
//               </div>
//             </motion.div>
            ...
            >
              <div className="text-center mb-6">
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <p className="text-orange-800 text-lg font-bold" style={{ fontFamily: 'Poppins, Roboto, sans-serif' }}>
                    Backend hosted on free service - may take time to respond
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start mb-6">
                ...
                />
                <label htmlFor="acknowledge" className="text-sm text-gray-700 cursor-pointer" style={{ fontFamily: 'Poppins, Roboto, sans-serif' }}>
              ...
              <div className="flex justify-end space-x-3">
                <motion.button
                  whileHover={{ scale: acknowledgeWarning ? 1.02 : 1 }}
                  whileTap={{ scale: acknowledgeWarning ? 0.98 : 1 }}
